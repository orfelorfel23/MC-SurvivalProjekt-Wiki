  ...
  return (
    <TooltipProvider delayDuration={100}>
      <Tooltip>
        ...
        <TooltipContent side="right" className="mc-panel p-3 border-border bg-background/95 backdrop-blur z-50 text-left max-w-xs pointer-events-none">
          <div className="text-primary font-bold mb-1">{title}</div>
          
          <div className="flex gap-2 flex-wrap text-[10px] mb-2 opacity-80">
            {item.rarity && <span className="border border-border px-1 rounded">{item.rarity}</span>}
