  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-sm text-muted-foreground mb-6">
        Inhalte werden direkt in den Tabellen verwaltet. Du kannst sie über die Cloud-Konsole
        hinzufügen, oder mir sagen, was du anlegen möchtest – ich kann strukturierte
